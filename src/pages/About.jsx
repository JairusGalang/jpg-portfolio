...
const About = ({ children }) => {
    return (
        <div className='flex flex-col items-center h-screen font-poppins'>
            <h1 className='text-4xl font-bold text-center mb-8'>About Me</h1>
            <div className='bg-white shadow-md rounded-lg p-6 max-w-6xl'>
                <p className='mb-6 font-poppins text-lg text-gray-600 mb-3'>
                ...
                <ul className='list-disc pl-6 text-base font-poppins text-gray-600 space-y-2'>
