...
const ContactMe = () => {
  return (
    <div className='min-h-screen min-h-screen p-2 sm:p-8 w-full max-w-6xl '>
      <h1 className='font-poppins text-3xl sm:text-4xl font-bold text-center mb-6 sm:mb-8'>Contact Me</h1>
